...
insert into usuario (id, nome, login, senha, ativo) values 
	(1, 'rafael', 'rafael', '$2a$10$JvyF9q/k/eYwXTVjc4Ay0OT/dCwjW14eT88q3e587jaENTvtt30s2', true)
	, (2, 'rose', 'rose', '$2a$10$JvyF9q/k/eYwXTVjc4Ay0OT/dCwjW14eT88q3e587jaENTvtt30s2', true)
;
